...
import { DeployBotDialog } from '@/shared/blocks/dashboard/deploy-bot-dialog';
  ...
  return (
    <div className="flex flex-col gap-2 px-3 py-3">
      {buttons.map((button, idx) =>
        button.type === 'deploy-bot' ? (
          <DeployBotDialog key={idx} button={button} isCollapsed={isCollapsed} />
        ) : (
          <Button
            key={idx}
            asChild
