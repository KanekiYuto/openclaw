...
const fs = require('fs');
const path = '/home/node/.openclaw/credentials/telegram-pairing.json';
...
`;
    ...
    const parsed: TelegramPairingFile = stdout
      ? JSON.parse(stdout)
      : { version: 1, requests: [] };
    ...
    console.log('get telegram pairing failed:', e);
    return respErr(e.message || 'get telegram pairing failed');
  }
}
